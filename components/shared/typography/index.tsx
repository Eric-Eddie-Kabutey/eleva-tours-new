...
const typoVariants = cva("overflow-wrap overflow-hidden leading-normal", {
  variants: {
    typo: {
      ...
      "header-2-bold": "xl:text-[49px] sm:text-[40px] sm:text-[35px] xs:text-[30px] text-[30px] xl:leading-[64px] sm:leading-[50px] leading-[40px] font-bold",
      ...
      "header-3-bold": "xl:text-[39px] lg:text-[35px] sm:text-[30px] text-[25px] xl:leading-[47px] md:leading-[45px] xs:leading-[35px] leading-[30px] font-bold",
      ...
      "header-5-bold": "xl:text-[25px] lg:text-[20px] xs:text-[18px] text-[16px] xl:leading-[30px] leading-[25px] font-bold",
